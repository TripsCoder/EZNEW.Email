...
Eznew.Email provides unified mail delivery management for the application, and provides a default mail delivery program implementation, or by implementing the IEmailEngine custom mail delivery implementation
